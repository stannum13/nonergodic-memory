...
- Save three training cells and six evaluation cells per protocol, a raw-only joined figure, limitations, and exact config/checkpoint provenance. Batch size and training-sequence diversity remain bundled with budget matching.
